...
<div class="wrapper">
	...
	<!-- Form -->
	<form class="form" id="form" action="<?php echo admin_url('chua/add') ?>" method="post" enctype="multipart/form-data">
		<fieldset>
			<div class="widget">
				<div class="title">
				...
				<div class="tab_container">
					<div id="tab1" class="tab_content pd0">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea name="tieu_de" id="param_tieu_de" rows="4" cols=""><?php echo set_value('tieu_de'); ?></textarea></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><input name="nguoi_chu_tri" value="<?php echo set_value('nguoi_chu_tri'); ?>" id="param_nguoi_chu_tri" _autocheck="true" type="text"></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><input name="nam_xay_dung" value="<?php echo set_value('nam_xay_dung'); ?>" id="param_nam_xay_dung" _autocheck="true" type="date"></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<div class="left"><input type="file" value="<?php echo set_value('anh'); ?>" id="param_anh" name="anh"></div>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<div class="left"><input type="file" value="<?php echo set_value('list_anh'); ?>" id="param_list_anh" name="list_anh[]" multiple=""></div>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<select name="id_tinh" _autocheck="true" id="param_id_tinh" class="left">
									<option value="">Lựa chọn Tỉnh/TP</option>
									<?php if (!empty($tinhs)): ?>
								...
								<div name="id_tinh_error" class="clear error"></div>
							</div>
							<div class="clear"></div>
						</div>
						...
						<div class="formRow">
							...
							<div class="formRight">
								...
								<div name="id_quan_error" class="clear error"></div>
							</div>
							<div class="clear"></div>
						</div>
						...
						<div class="formRow">
							...
							<div class="formRight">
								...
								<div name="id_phuong_error" class="clear error"></div>
							</div>
							<div class="clear"></div>
						</div>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><input name="so_nha" value="<?php echo set_value('so_nha'); ?>" id="param_so_nha" _autocheck="true" type="text"></span>
					...
					<div id="tab3" class="tab_content pd0">
						<div class="formRow">
							...
							<div class="formRight" style="min-height: 500px">
								<textarea name="mo_ta"  id="param_mo_ta" class="editor"><?php echo set_value('mo_ta'); ?></textarea>
