...
<div class="wrapper">
	...
	<!-- Form -->
	<form class="form" id="form" action="<?php echo admin_url('danhmuc/edit/'.$danhmuc->id) ?>" method="post" enctype="multipart/form-data">
		<fieldset>
			<div class="widget">
				<div class="title">
				...
				<div class="tab_container">
					<div id="tab1" class="tab_content pd0">
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><input name="ten" value="<?php echo $danhmuc->ten; ?>" id="param_ten" _autocheck="true" type="text"></span>
								...
								<select name="parent_id" _autocheck="true" id="param_parent_id" class="left">
									...
									<?php if(!empty($parent_id)){
										foreach ($parent_id as $value) {
											if($value->id == $danhmuc->parent_id){
												?>
											
									<option selected value="<?php echo $value->id ?>"><?php echo $value->ten ?></option>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><input class="format_number" name="sort_order" value="<?php echo $danhmuc->sort_order; ?>" id="param_sort_order" _autocheck="true" min="0" type="text"></span>
