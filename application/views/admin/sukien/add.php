...
<div class="wrapper">
	...
	<!-- Form -->
	<form class="form" id="form" action="<?php echo base_url('admin'); ?>/sukien/add" method="post" enctype="multipart/form-data">
		<fieldset>
			<div class="widget">
				<div class="title">
					<img src="<?php echo public_url('admin'); ?>/images/icons/dark/add.png" class="titleIcon">
					<h6>Thêm mới sự kiện</h6>
				</div>
				...
				<div class="tab_container">
					<div id="tab1" class="tab_content pd0">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><input name="ngay_dien_ra" value="<?php echo set_value('ngay_dien_ra'); ?>" id="param_ngay_dien_ra" _autocheck="true" type="date"></span>
