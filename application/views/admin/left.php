...
<div id="leftSide" style="padding-top:30px;">
	...
	<div class="sideProfile">
		...
		<span><strong><a href="<?php echo admin_url('taikhoan/doimatkhau'); ?>">Đổi mật khẩu</a></strong></span>
		<div class="clear"></div>
	</div>
	...
	<ul id="menu" class="nav">
		...
		<li class="product">
			...
			<ul class="sub">
				<li >
					<a href="<?php echo admin_url('chua'); ?>">
					Chùa							</a>
				</li>
				<li >
					<a href="<?php echo admin_url('sukien'); ?>">
					Sự kiện						</a>
				</li>
		...
		<li class="account">
			...
			<ul class="sub">
				<li >
					<a href="<?php echo admin_url('taikhoan'); ?>">
					Người dùng							</a>
				</li>
				<!-- <li >
