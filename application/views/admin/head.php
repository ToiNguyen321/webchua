...
<!-- Favicon -->
<link rel="icon" href="<?php echo public_url('admin'); ?>/images/fabinico.ico">
...
<link rel="stylesheet" type="text/css" href="<?php echo public_url('admin'); ?>/css/custom.css" media="screen" />
